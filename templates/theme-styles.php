<?php
  ...
  /**
  * This template generates dynamic styles.
  * Variables:
  * $navbar_min_height_desktop - navbar height on large screen devices
  * $navbar_logo_height_desktop - logo height on large screen devices
  * $navbar_min_height_mobile - navbar height on small screen devices
  * $navbar_logo_height_mobile - logo height on small screen devices
...
<style>
  /**
  * General styles, applicable to all Luca themes
  */
  /* link colors */
  a {
  ...
  /* .altMediaObject */
  .altMediaObject_title {
    color: <?= $brand_primary_color ?>;
  }

  a.altMediaObject_title:hover,
  a.altMediaObject_title:focus {
    color: <?= $brand_primary_color ?>;
  }

  .altMediaObject_navLink {
    color: <?= $brand_primary_color ?>;
  }
  ...
  .sliderTile_text a:hover,
  .sliderTile_text a:focus {
    color: <?= $brand_primary_color ?>;
  }

  .sliderTile .flex-control-nav li a.flex-active {
    background-color: <?= $brand_primary_color ?>;
  }
